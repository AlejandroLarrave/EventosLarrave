...
@NamedQueries({
    ...
    , @NamedQuery(name = "Detallefactura.findByIdfacturacion", query = "SELECT d FROM Detallefactura d WHERE d.idfacturacion = :idfacturacion")
...
public class Detallefactura implements Serializable {
    ...
    public Detallefactura(Integer iddetallefactura, int idfacturacion, int idproductos, int cantidad, double precio) {
        this.iddetallefactura = iddetallefactura;
    ...
    public String toString() {
        return "com.alejandrolarrave.entities.Detallefactura[ iddetallefactura=" + iddetallefactura + " ]";
    }
